====================================7-11 sections==============================================
070 [Object.keys(arg)]// loop through non-interating object
const movieRating = {
	dog: 1,
	cat: 2,
	rat: -1
...
070 [ForIn] // loop (for in) ITERATES THROUGHT OBJECT IN JS (key - dog cat, moneyAwards[key] - 100,1000,50)
const moneyAwards = {
	dog: 100,
	cat: 1000,
	rat: 50
...
const [gold, silver,/*минус мыша*/, ...theRest] = raceResults;
console.log(...theRest);

0115 [DESTRUCTURING] //for OBJECT pretty useless imho
const myCat = {
  name: 'Uasya',
  type: 'Ordinary-cat',
  title: 'Beloved Cat',
...
0116 [DESTRUCTURING] //for NASTED Objects in Array
const results = [{
    first: "Eliud",
    last: "Kipchoge",
    country: "Kenya",
...
const [{ first: goldWinner }, /*Second Element starts*/{ country }] = results;
//const [,silverMedal] - results; const {country} = silverMedal;
goldWinner; //"Eliud"
country; //"Ethiopia"

0117 [DESTRUCTURING PARAMETERS]
